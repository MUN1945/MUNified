        ...
        <Card className="bg-white/[0.06] border-white/[0.08] backdrop-blur-xl overflow-hidden">
          <form onSubmit={handleSubmit}>
            <CardHeader className="text-center pb-2">
              <CardTitle className="text-2xl text-white">{t('auth.signIn.title')}</CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label className="text-white/70 text-sm">{t('auth.signIn.email')}</Label>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <Label className="text-white/70 text-sm">{t('auth.signIn.password')}</Label>
                  <Link
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-white/50">{t('auth.signIn.rememberMe')}</span>
              </div>
              ...
              >
                {isLoading ? (
                  ...
                  <>{t('auth.signIn.submit')} <ArrowRight className="w-4 h-4 ml-2" /></>
                )}
              </Button>
            </CardContent>
